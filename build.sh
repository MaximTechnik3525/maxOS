...
$LD --no-warn-rwx-segments -T src/linker.ld -o build/mykernel.bin \
    build/entry.o build/mbr_data.o build/syscall_asm.o build/user.o \
    build/kernel.o build/ata.o build/maxfs.o \
...
menuentry "maxOS RedCycle v3.0 (x86_64 Long Mode)" {
...
echo "============================================="
echo " Сборка 64-битной maxOS v3.0 завершена успешно!"
