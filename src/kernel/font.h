...
// 12x12 mouse pointer cursor bitmap (1=border, 2=fill, 3=shadow, 0=transparent)
static const unsigned char mouse_arrow[12][12] = {
...
static const unsigned char max_font[] = {
