...
; ------------------------------------------------------------------------------
; divide_error_entry (Vector 0 - #DE Divide by Zero):
; Hardware pushed: SS, RSP, RFLAGS, CS, RIP (No error code)
; ------------------------------------------------------------------------------
divide_error_entry:
    push rax
    push rcx
    ...
    mov rdi, [rsp + 72]         ; 1st arg: faulting RIP
    mov rsi, [rsp + 80]         ; 2nd arg: faulting CS
    sub rsp, 8
...
; ------------------------------------------------------------------------------
; invalid_opcode_entry (Vector 6 - #UD Invalid Opcode):
; Hardware pushed: SS, RSP, RFLAGS, CS, RIP (No error code)
; ------------------------------------------------------------------------------
...
; ------------------------------------------------------------------------------
; double_fault_entry (Vector 8 - #DF Double Fault):
